...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        '✔ Kanıta dayalı klinik yapay zeka': '✔ Evidence-based clinical AI',
        '✔ Klinik muhakeme ve karar desteği': '✔ Clinical reasoning and decision support',
        '✔ AI scribe ve kanıt sentezi': '✔ AI scribe and evidence synthesis',
        'Grammarly': 'Grammarly',
        '✔ Yapay zeka destekli yazım asistanı': '✔ AI writing assistance',
        '✔ Dil bilgisi, ton ve açıklık önerileri': '✔ Grammar, tone, and clarity suggestions',
        '✔ Öğrenciler ve kurumlar için araçlar': '✔ Tools for students and institutions',
        'Superhuman Suite': 'Superhuman Suite',
        '✔ Yapay zeka üretkenlik paketi': '✔ AI productivity suite',
        '✔ E-posta, doküman ve iş akışı desteği': '✔ Email, documents, and workflow support',
        '✔ Günlük işler için yapay zeka asistanı': '✔ AI assistant across everyday work',
